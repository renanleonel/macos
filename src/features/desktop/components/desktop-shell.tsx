  ...
  return (
    <main
      className={cn(
        ...
        '[&.desktop--dark_.menu-bar]:text-[white] [&.desktop--dark_.menu-bar]:[text-shadow:0_0_8px_oklch(0.1_0.02_250/0.6),0_1px_2px_oklch(0.1_0.02_250/0.5)] [&.desktop--dark_.menu-bar]:[--control-center-knob:oklch(0.13_0.008_250)]',
        '[&.desktop--dark_.menu-bar_button:hover]:[background:oklch(1_0_0/0.14)] [&.desktop--dark_.menu-bar_button:hover]:[box-shadow:inset_0_1px_oklch(1_0_0/0.24),inset_0_0_0_1px_oklch(1_0_0/0.12)]',
        "[&.desktop--dark_.menu-bar_button[aria-expanded='true']]:[background:oklch(1_0_0/0.18)] [&.desktop--dark_.menu-bar_button[aria-expanded='true']]:[box-shadow:inset_0_1px_oklch(1_0_0/0.3),inset_0_0_0_1px_oklch(1_0_0/0.16)]",
        ...
        // Glass tints themselves live in the shared liquid-glass constants; only
        // the content colours that ride on top of them are set here.
        '[&.desktop--dark_.system-menu]:text-(--label-primary)',
        '[&.desktop--dark_.control-center]:text-(--label-primary) [&.desktop--dark_.control-grid_button]:text-(--label-primary)',
        '[&.desktop--dark_.control-grid_button:not(.on)_>_span]:[background:oklch(1_0_0/0.14)] [&.desktop--dark_.control-grid_button:not(.on)_>_span]:[box-shadow:inset_0_1px_oklch(1_0_0/0.14)]',
