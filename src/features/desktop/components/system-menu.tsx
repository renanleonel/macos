  ...
  return (
    <div
      className={cn(
        ...
        '[&.system-menu_>_button]:w-full [&.system-menu_>_button]:min-h-6.75 [&.system-menu_>_button]:flex [&.system-menu_>_button]:items-center [&.system-menu_>_button]:justify-between [&.system-menu_>_button]:p-[3px_9px] [&.system-menu_>_button]:[border:0] [&.system-menu_>_button]:rounded-[7px] [&.system-menu_>_button]:[background:transparent] [&.system-menu_>_button]:text-left [&.system-menu_>_button]:text-[13px] [&.system-menu_>_button]:[transition-property:scale] [&.system-menu_>_button]:duration-120 [&.system-menu_>_button]:ease-[ease-out]',
        '[&.system-menu_>_button:hover]:text-[white] [&.system-menu_>_button:hover]:[background:var(--system-blue-deep)] [&.system-menu_>_button:hover]:[box-shadow:inset_0_1px_oklch(1_0_0/0.2)]',
        ...
        '[&.system-menu_>_button:active]:scale-[0.96]',
